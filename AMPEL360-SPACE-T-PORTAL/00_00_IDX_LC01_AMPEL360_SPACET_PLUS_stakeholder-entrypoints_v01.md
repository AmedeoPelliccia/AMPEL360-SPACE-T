...
- Entry point: [CM — Configuration Management](STK_CM-cm-configuration-management/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-cm-entrypoint_v01.md)  
...
- Entry point: [PMO — Program Management Office](STK_PMO-pmo-program-management-office/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-pmo-entrypoint_v01.md)  
...
- Entry point: [SE — Systems Engineering](STK_SE-se-systems-engineering/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-se-entrypoint_v01.md)  
...
### SAF — Safety
- Entry point: [SAF — Safety](STK_SAF-saf-safety/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-saf-entrypoint_v01.md)  
...
- Entry point: [CERT — Certification & Authorities](STK_CERT-cert-certification-authorities/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-cert-entrypoint_v01.md)  
...
### OPS — Operations
- Entry point: [OPS — Operations](STK_OPS-ops-operations/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-ops-entrypoint_v01.md)  
...
- Entry point: [SPACEPORT — Spaceport/Airport Ops](STK_SPACEPORT-spaceport-spaceport-airport-ops/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-spaceport-entrypoint_v01.md)  
...
### MRO — MRO / Maintenance
- Entry point: [MRO — MRO / Maintenance](STK_MRO-mro-mro-maintenance/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-mro-entrypoint_v01.md)  
...
- Entry point: [DATA — Data Governance](STK_DATA-data-data-governance/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-data-entrypoint_v01.md)  
...
- Entry point: [AI — AI/ML Engineering](STK_AI-ai-ai-ml-engineering/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-ai-entrypoint_v01.md)  
...
### CY — Cybersecurity
- Entry point: [CY — Cybersecurity](STK_CY-cy-cybersecurity/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-cy-entrypoint_v01.md)  
...
### TEST — IVVQ / Testing
- Entry point: [TEST — IVVQ / Testing](STK_TEST-test-ivvq-testing/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_stakeholder-test-entrypoint_v01.md)  
...
- K06 — Data Governance (SSOT / Schemas / Identifiers)  
  ...
  - Master K06 index: [K06 master index](STK_AI-ai-ai-ml-engineering/KNOTS/K06_data-governance-ssot-schemas-identifiers/00_00_IDX_LC01_AMPEL360_SPACET_PLUS_k06-data-governance-ssot-schemas-identifiers_v01.md)
