...
|:------------|:---|:------------|:------------|
| **AI/ML Engineering** | AI | [stakeholder-ai-entrypoint](STK_AI-ai-ai-ml-engineering/00_00_IDX_LC01_SPACET_stakeholder-ai-entrypoint_v01.md) | ML lifecycle, datasets, models, TEKNIA packaging |
| **Certification & Authorities** | CERT | [stakeholder-cert-entrypoint](STK_CERT-cert-certification-authorities/00_00_IDX_LC01_SPACET_stakeholder-cert-entrypoint_v01.md) | Authority engagement, compliance mapping, evidence packaging |
| **Configuration Management** | CM | [stakeholder-cm-entrypoint](STK_CM-cm-configuration-management/00_00_IDX_LC01_SPACET_stakeholder-cm-entrypoint_v01.md) | Governance spine, baselines, change control, CI enforcement |
| **Cybersecurity** | CY | [stakeholder-cy-entrypoint](STK_CY-cy-cybersecurity/00_00_IDX_LC01_SPACET_stakeholder-cy-entrypoint_v01.md) | Threat models, security requirements, SBOM coupling |
| **Data Governance** | DATA | [stakeholder-data-entrypoint](STK_DATA-data-data-governance/00_00_IDX_LC01_SPACET_stakeholder-data-entrypoint_v01.md) | SSOT definitions, schema governance, identifier discipline |
| **MRO / Maintenance** | MRO | [stakeholder-mro-entrypoint](STK_MRO-mro-mro-maintenance/00_00_IDX_LC01_SPACET_stakeholder-mro-entrypoint_v01.md) | Maintainability, servicing, continued airworthiness |
| **Operations** | OPS | [stakeholder-ops-entrypoint](STK_OPS-ops-operations/00_00_IDX_LC01_SPACET_stakeholder-ops-entrypoint_v01.md) | Operational concepts, procedures, mission profiles |
| **Program Management Office** | PMO | [stakeholder-pmo-entrypoint](STK_PMO-pmo-program-management-office/00_00_IDX_LC01_SPACET_stakeholder-pmo-entrypoint_v01.md) | Program cadence, milestones, resourcing, prioritization |
| **Safety** | SAF | [stakeholder-saf-entrypoint](STK_SAF-saf-safety/00_00_IDX_LC01_SPACET_stakeholder-saf-entrypoint_v01.md) | Safety processes, hazard logs, safety cases |
| **Systems Engineering** | SE | [stakeholder-se-entrypoint](STK_SE-se-systems-engineering/00_00_IDX_LC01_SPACET_stakeholder-se-entrypoint_v01.md) | System architecture, ICDs, requirements decomposition |
| **Spaceport/Airport Ops** | SPACEPORT | [stakeholder-spaceport-entrypoint](STK_SPACEPORT-spaceport-spaceport-airport-ops/00_00_IDX_LC01_SPACET_stakeholder-spaceport-entrypoint_v01.md) | Ground operations, turnaround, fueling/servicing interfaces |
| **IVVQ / Testing** | TEST | [stakeholder-test-entrypoint](STK_TEST-test-ivvq-testing/00_00_IDX_LC01_SPACET_stakeholder-test-entrypoint_v01.md) | Verification strategy, test evidence nodes, qualification |

📋 **Master Index**: [`00_00_IDX_LC01_SPACET_stakeholder-entrypoints_v01.md`](00_00_IDX_LC01_SPACET_stakeholder-entrypoints_v01.md)
...
📊 **Knot Register**: [`00_00_TAB_LC01_SPACET_knot-register_v01.csv`](00_00_TAB_LC01_SPACET_knot-register_v01.csv)
...
1. **Monitor Knot Progress**
   - Review [`00_00_TAB_LC01_SPACET_knot-register_v01.csv`](00_00_TAB_LC01_SPACET_knot-register_v01.csv)
...
📖 **Full Standard**: [`00_00_STD_LC01_SPACET_nomenclature-standard_v02.md`](../00_00_STD_LC01_SPACET_nomenclature-standard_v02.md)
...
📋 **CI Gates**: [`00_00_IDX_LC01_SPACET_ci-governance-gates_v01.md`](../00_00_IDX_LC01_SPACET_ci-governance-gates_v01.md)
...
| Resource | Link |
|:---------|:-----|
| Master Stakeholder Index | [`00_00_IDX_LC01_SPACET_stakeholder-entrypoints_v01.md`](00_00_IDX_LC01_SPACET_stakeholder-entrypoints_v01.md) |
| Knot Register | [`00_00_TAB_LC01_SPACET_knot-register_v01.csv`](00_00_TAB_LC01_SPACET_knot-register_v01.csv) |
| Nomenclature Standard | [`../00_00_STD_LC01_SPACET_nomenclature-standard_v02.md`](../00_00_STD_LC01_SPACET_nomenclature-standard_v02.md) |
| Governance Policy | [`../00_00_STD_LC01_SPACET_governance-reference-policy_v01.md`](../00_00_STD_LC01_SPACET_governance-reference-policy_v01.md) |
| CI Gates | [`../00_00_IDX_LC01_SPACET_ci-governance-gates_v01.md`](../00_00_IDX_LC01_SPACET_ci-governance-gates_v01.md) |
