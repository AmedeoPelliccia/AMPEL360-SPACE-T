...
- WBS index: [K06 ATA 45 Work Breakdown](01_WBS/45_00_IDX_LC01_SPACET_k06-ata-45-workbreakdown_v01.md)  
...
- RACI (CSV): [RACI](01_WBS/45_00_MAT_LC06_SPACET_k06-ata-45-raci_v01.csv)  
...
- T001: [SSOT source & ownership](01_WBS/45_00_ACT_LC06_SPACET_k06-t001-ssot-source-ownership_v01.md)  
  _Comment:_ Declares authoritative SSOT for message catalogs and interface contracts and defines change control.

- T002: [Identifier grammar](01_WBS/45_00_ACT_LC06_SPACET_k06-t002-identifier-grammar_v01.md)  
  _Comment:_ Defines canonical IDs for messages/topics/channels and constraints on naming/versioning.

- T003: [Schema definition](01_WBS/45_00_ACT_LC06_SPACET_k06-t003-schema-definition_v01.md)  
  _Comment:_ Stabilizes payload semantics (fields, units, frames, enums, validity, timestamps).

- T004: [Export publication](01_WBS/45_00_ACT_LC06_SPACET_k06-t004-export-publication_v01.md)  
  _Comment:_ Defines published interface contract exports (schemas + catalogs) and deterministic generation.

- T005: [CI validation gates](01_WBS/45_00_ACT_LC06_SPACET_k06-t005-ci-validation-gates_v01.md)  
  _Comment:_ Enforces contract/schema rules and blocks noncompliant PRs.

- T006: [Baseline interface contract set](01_WBS/45_00_ACT_LC06_SPACET_k06-t006-baseline-interface-contract-set_v01.md)  
...
- Standard (STD): [Identifier grammar](02_IDS_REGISTRY/45_00_STD_LC03_SPACET_message-identifier-grammar_v01.md)  
  _Done when:_ Grammar is approved and referenced by schema + CI gates.

- Registry (TAB/CSV): [Message & interface registry](02_IDS_REGISTRY/45_00_TAB_LC03_SPACET_message-interface-registry_v01.csv)  
  _Done when:_ Registry is SSOT (no duplicates), with owners/status and required metadata.

- Change log (LOG): [Registry change log](02_IDS_REGISTRY/45_00_LOG_LC03_SPACET_registry-change-log_v01.md)  
...
- Schema (SCH/JSON): [Interface payload schema](03_SCHEMA/45_00_SCH_LC03_SPACET_interface-payload-schema_v01.json)  
  _Done when:_ Schema validates exports and is referenced by CI.

- Standard (STD): [Schema versioning policy](03_SCHEMA/45_00_STD_LC03_SPACET_schema-versioning-policy_v01.md)  
  _Done when:_ Compatibility/breaking-change rules exist and are enforced.

- Units/Frames map (TAB/CSV): [Units and frames mapping](03_SCHEMA/45_00_TAB_LC03_SPACET_units-frames-mapping_v01.csv)  
...
- Baseline dataset (TAB/CSV): [Baseline interface contract set](04_EXPORTS/45_00_TAB_LC04_SPACET_baseline-interface-contract-set_v01.csv)  
  _Done when:_ Export is reproducible, validated, and release-referenced.

- Manifest (RPT): [Export manifest](04_EXPORTS/45_00_RPT_LC04_SPACET_export-manifest_v01.md)  
  _Done when:_ Inputs/tools/versions are recorded; rebuild is deterministic.

- Diagram (DIA): [Interface map](04_EXPORTS/45_00_DIA_LC04_SPACET_interface-map_v01.md)  
...
- Requirements (STD): [CI validation requirements](05_CI_GATES/45_00_STD_LC05_SPACET_ci-validation-requirements_v01.md)  
  _Done when:_ Rules map to checks; failures are actionable.

- Checklist (LOG): [CI checklist](05_CI_GATES/45_00_LOG_LC05_SPACET_ci-checklist_v01.md)  
  _Done when:_ Checklist matches CI outputs and reviewer expectations.

- Sample run (RPT): [CI validation sample run](05_CI_GATES/45_00_RPT_LC05_SPACET_ci-validation-sample-run_v01.md)  
...
- Evidence pack index (IDX): [Evidence pack](06_EVIDENCE/45_00_IDX_LC06_SPACET_k06-ata-45-evidence-pack_v01.md)  
  _Done when:_ All required evidence is linked and current.

- Evidence links (TRC/CSV): [Evidence links register](06_EVIDENCE/45_00_TRC_LC06_SPACET_k06-ata-45-evidence-links_v01.csv)  
  _Done when:_ Each claim has an evidence link and status (OK/STALE/MISSING).

- NKU ledger (TAB/CSV): [NKU ledger](06_EVIDENCE/45_00_TAB_LC06_SPACET_k06-ata-45-nku-ledger_v01.csv)  
...
- Decision minutes (MIN): [Decision minutes](07_DECISIONS/45_00_MIN_LC07_SPACET_k06-ata-45-decision-minutes_v01.md)  
  _Done when:_ Decision, rationale, dissent/risks are recorded.

- Approvals log (LOG): [Approvals log](07_DECISIONS/45_00_LOG_LC07_SPACET_k06-ata-45-approvals_v01.md)  
...
- Consumers (TRC/CSV): [Consumers list](08_TRACEABILITY/45_00_TRC_LC08_SPACET_k06-ata-45-consumers_v01.csv)  
  _Done when:_ Consumers are listed with interface/version and owner.

- Adoption status (RPT): [Adoption status](08_TRACEABILITY/45_00_RPT_LC08_SPACET_k06-ata-45-adoption-status_v01.md)  
...
**Source of truth:** [NKU ledger](06_EVIDENCE/45_00_TAB_LC06_SPACET_k06-ata-45-nku-ledger_v01.csv)
