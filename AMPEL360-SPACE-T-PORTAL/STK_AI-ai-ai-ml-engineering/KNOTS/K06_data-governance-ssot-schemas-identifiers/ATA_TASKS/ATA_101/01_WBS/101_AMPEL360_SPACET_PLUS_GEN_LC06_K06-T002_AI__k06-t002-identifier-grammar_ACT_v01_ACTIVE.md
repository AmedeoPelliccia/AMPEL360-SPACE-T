...
| T002-02 | Define canonical ID grammar for sim/test entities | AI + SE | TBD | High | Open | Formal specification |
...
**Description:**
Survey and document all existing identifier schemes used for simulation runs, test campaigns, test cases, datasets, and evidence packs.
...
**Description:**
Define the canonical identifier grammar for all sim/test entities including runs, campaigns, cases, datasets, and evidence packs.

**Context:**
A stable, unique ID grammar prevents duplicates and enables traceability across the sim/test lifecycle.

**Acceptance Criteria:**
- [ ] Grammar specification document created
- [ ] Covers: runs, campaigns, cases, datasets, evidence packs
...
**Description:**
Define rules and mechanisms to prevent duplicate identifiers from being issued.

**Context:**
Duplicate IDs cause traceability failures and certification evidence corruption.
...
**Context:**
Controlled allocation ensures ID uniqueness and maintains registry integrity.
...
**Description:**
Publish the identifier grammar as a formal standard (STD artifact) for use across ATA 101.
...
- [ ] Canonical IDs defined for runs/campaigns/cases/datasets/evidence packs
