---
title: "K06 ATA 101 Work Breakdown Structure"
type: IDX
project: AMPEL360
program: SPACET
variant: PLUS
...
description: "Work Breakdown Structure for K06 (Data Governance / SSOT / Schemas / Identifiers) for ATA 101 (Sim/Test Domain)"
---

# K06 ATA 101 — Work Breakdown Structure (WBS)

## Overview

This index provides the Work Breakdown Structure for closing **K06** (Data Governance / SSOT / Schemas / Identifiers) for **ATA 101** (Simulation & Testing domain).
...
| Task | AI | DATA | CM | SE | CERT | TEST | V&V |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
