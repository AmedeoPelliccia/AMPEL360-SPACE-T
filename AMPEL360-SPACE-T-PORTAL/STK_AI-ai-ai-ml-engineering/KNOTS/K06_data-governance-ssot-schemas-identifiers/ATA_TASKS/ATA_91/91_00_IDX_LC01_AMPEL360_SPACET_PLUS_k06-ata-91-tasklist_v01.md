...
- WBS index: [K06 ATA 91 Work Breakdown](01_WBS/91_00_IDX_LC01_SPACET_k06-ata-91-workbreakdown_v01.md)  
...
- RACI (CSV): [RACI](01_WBS/91_00_MAT_LC06_SPACET_k06-ata-91-raci_v01.csv)  
...
- T001: [SSOT source & ownership](01_WBS/91_00_ACT_LC06_SPACET_k06-t001-ssot-source-ownership_v01.md)  
  _Comment:_ Declares SSOT locations for schema registry and canonical models; sets change control authority.

- T002: [Identifier grammar](01_WBS/91_00_ACT_LC06_SPACET_k06-t002-identifier-grammar_v01.md)  
  _Comment:_ Canonical ID grammar for schema IDs, versions, namespaces, and packages.

- T003: [Schema registry definition](01_WBS/91_00_ACT_LC06_SPACET_k06-t003-schema-registry-definition_v01.md)  
  _Comment:_ Defines required fields, discovery metadata, and registry workflows.

- T004: [Versioning & compatibility policy](01_WBS/91_00_ACT_LC06_SPACET_k06-t004-versioning-compatibility-policy_v01.md)  
  _Comment:_ Defines breaking/nonbreaking rules, deprecation windows, and migration obligations.

- T005: [CI validation gates](01_WBS/91_00_ACT_LC06_SPACET_k06-t005-ci-validation-gates_v01.md)  
  _Comment:_ Enforces schema validity, registry completeness, and versioning compliance.

- T006: [Schema pack export](01_WBS/91_00_ACT_LC06_SPACET_k06-t006-schema-pack-export_v01.md)  
  _Comment:_ Defines deterministic packaging and publication of schema packs (for consumption and evidence).

- T007: [Canonical model alignment](01_WBS/91_00_ACT_LC06_SPACET_k06-t007-canonical-model-alignment_v01.md)  
  _Comment:_ Ensures shared entity definitions remain consistent across ATAs.

- T008: [Schema consumer onboarding](01_WBS/91_00_ACT_LC06_SPACET_k06-t008-schema-consumer-onboarding_v01.md)  
...
- Standard (STD): [Identifier grammar](02_IDS_REGISTRY/91_00_STD_LC03_SPACET_schema-identifier-grammar_v01.md)  
  _Done when:_ Grammar is approved and referenced by CI and all schema documents.

- Registry (TAB/CSV): [Schema registry](02_IDS_REGISTRY/91_00_TAB_LC03_SPACET_schema-registry_v01.csv)  
  _Done when:_ Registry is SSOT (no duplicates), with owners/status and required metadata.

- Registry (TAB/CSV): [Canonical model registry](02_IDS_REGISTRY/91_00_TAB_LC03_SPACET_canonical-model-registry_v01.csv)  
  _Done when:_ All canonical entities are registered and referenced by schemas.

- Change log (LOG): [Registry change log](02_IDS_REGISTRY/91_00_LOG_LC03_SPACET_registry-change-log_v01.md)  
...
- Schema (SCH/JSON): [Schema registry schema](03_SCHEMA/91_00_SCH_LC03_SPACET_schema-registry-schema_v01.json)  
  _Done when:_ Validates registry format and is used by CI.

- Standard (STD): [Schema versioning policy](03_SCHEMA/91_00_STD_LC03_SPACET_schema-versioning-policy_v01.md)  
  _Done when:_ Compatibility/breaking-change rules exist and are enforced.

- Standard (STD): [Deprecation & migration policy](03_SCHEMA/91_00_STD_LC03_SPACET_schema-migration-policy_v01.md)  
  _Done when:_ Deprecation windows and migration artifacts are mandatory and defined.

- Units/Frames/Enums map (TAB/CSV): [Common primitives mapping](03_SCHEMA/91_00_TAB_LC03_SPACET_common-primitives-mapping_v01.csv)  
...
- Baseline export (TAB/CSV): [Baseline schema registry export](04_EXPORTS/91_00_TAB_LC04_SPACET_baseline-schema-registry-export_v01.csv)  
  _Done when:_ Export is reproducible and validated.

- Schema pack manifest (RPT): [Schema pack manifest](04_EXPORTS/91_00_RPT_LC04_SPACET_schema-pack-manifest_v01.md)  
  _Done when:_ Tools/versions, included schemas, and checksums are listed.

- Diagram (DIA): [Schema dependency map](04_EXPORTS/91_00_DIA_LC04_SPACET_schema-dependency-map_v01.md)  
...
- Requirements (STD): [CI validation requirements](05_CI_GATES/91_00_STD_LC05_SPACET_ci-validation-requirements_v01.md)  
  _Done when:_ Rules map to checks; failures are actionable.

- Checklist (LOG): [CI checklist](05_CI_GATES/91_00_LOG_LC05_SPACET_ci-checklist_v01.md)  
  _Done when:_ Checklist matches CI outputs and reviewer expectations.

- Sample run (RPT): [CI validation sample run](05_CI_GATES/91_00_RPT_LC05_SPACET_ci-validation-sample-run_v01.md)  
...
- Evidence pack index (IDX): [Evidence pack](06_EVIDENCE/91_00_IDX_LC06_SPACET_k06-ata-91-evidence-pack_v01.md)  
  _Done when:_ All required evidence is linked and current.

- Evidence links (TRC/CSV): [Evidence links register](06_EVIDENCE/91_00_TRC_LC06_SPACET_k06-ata-91-evidence-links_v01.csv)  
  _Done when:_ Each claim has an evidence link and status (OK/STALE/MISSING).

- NKU ledger (TAB/CSV): [NKU ledger](06_EVIDENCE/91_00_TAB_LC06_SPACET_k06-ata-91-nku-ledger_v01.csv)  
...
- Decision minutes (MIN): [Decision minutes](07_DECISIONS/91_00_MIN_LC07_SPACET_k06-ata-91-decision-minutes_v01.md)  
  _Done when:_ Decision, rationale, dissent/risks are recorded.

- Approvals log (LOG): [Approvals log](07_DECISIONS/91_00_LOG_LC07_SPACET_k06-ata-91-approvals_v01.md)  
...
- Consumers (TRC/CSV): [Consumers list](08_TRACEABILITY/91_00_TRC_LC08_SPACET_k06-ata-91-consumers_v01.csv)  
  _Done when:_ Consumers are listed with schema/version and owner.

- Adoption status (RPT): [Adoption status](08_TRACEABILITY/91_00_RPT_LC08_SPACET_k06-ata-91-adoption-status_v01.md)  
...
**Source of truth:** [NKU ledger](06_EVIDENCE/91_00_TAB_LC06_SPACET_k06-ata-91-nku-ledger_v01.csv)
