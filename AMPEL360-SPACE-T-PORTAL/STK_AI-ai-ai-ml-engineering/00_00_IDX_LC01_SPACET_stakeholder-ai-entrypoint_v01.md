...
- **K07** — ai-autonomy-assurance-monitoring → `K07_ai-autonomy-assurance-monitoring/`
- **K06** — data-governance-ssot-schemas-identifiers → `K06_data-governance-ssot-schemas-identifiers/`
- **K13** — cybersecurity-zones-key-management → `K13_cybersecurity-zones-key-management/`
