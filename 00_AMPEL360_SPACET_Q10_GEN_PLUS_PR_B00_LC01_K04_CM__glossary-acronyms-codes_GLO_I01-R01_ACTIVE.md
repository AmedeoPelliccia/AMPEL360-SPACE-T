...
| **PHM** | Physical & Mechanical (also: Prognostics & Health Management) | In this project: **STK_PHM** means **Physical & Mechanical**; CMS/health monitoring is handled under **STK_DATA** with ops/MRO deps |
...
**Maintained By:** STK_CM (Configuration Management)  
...
| :--- | :--- | :--- | :--- |
| 2025-12-18 | All sections | Initial version with 5 main categories (A-E) | STK_CM |

---

## Notes

This glossary is maintained under Configuration Management governance and aligned with:
- Nomenclature Standard v6.0 R1.0 (FINAL LOCK)
- OPT-INS Framework v1.1
- K04 Configuration Management knot
