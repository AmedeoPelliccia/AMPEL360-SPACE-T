---
name: Post-Retrofit Cleanup for CM
about: Track remaining issues after v5.0 nomenclature retrofit in STK_CM-cm-configuration-management
...
**AoR:** CM  
**Portal Directory:** `STK_CM-cm-configuration-management`  
**Report:** `STK_CM-cm-configuration-management/00_AMPEL360_SPACET_Q10_GEN_PLUS_PR_GEN_LC01_K04_CM__v5-retrofit-report_RPT_I01-R01_ACTIVE.md`

## Context

This issue tracks remaining cleanup tasks after the Nomenclature v5.0 retrofit for the **CM** area of responsibility. All files in this portal have been successfully migrated to v5.0 format with 100% validation compliance, but some cross-references and links require manual review.

## Retrofit Summary

- **Files migrated:** 87 files in this AoR
...
**How to Check:**
```bash
cd AMPEL360-SPACE-T-PORTAL/STK_CM-cm-configuration-management
...
**Assigned Workspace:** `STK_CM-cm-configuration-management`
