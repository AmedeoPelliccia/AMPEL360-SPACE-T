---
name: Post-Retrofit Cleanup for CERT
about: Track remaining issues after v5.0 nomenclature retrofit in STK_CERT-cert-certification-authorities
...
**AoR:** CERT  
**Portal Directory:** `STK_CERT-cert-certification-authorities`  
**Report:** `STK_CERT-cert-certification-authorities/00_AMPEL360_SPACET_Q10_GEN_PLUS_PR_GEN_LC01_K04_CERT__v5-retrofit-report_RPT_I01-R01_ACTIVE.md`

## Context

This issue tracks remaining cleanup tasks after the Nomenclature v5.0 retrofit for the **CERT** area of responsibility. All files in this portal have been successfully migrated to v5.0 format with 100% validation compliance, but some cross-references and links require manual review.

## Retrofit Summary

- **Files migrated:** 857 files in this AoR
...
**How to Check:**
```bash
cd AMPEL360-SPACE-T-PORTAL/STK_CERT-cert-certification-authorities
...
**Assigned Workspace:** `STK_CERT-cert-certification-authorities`
