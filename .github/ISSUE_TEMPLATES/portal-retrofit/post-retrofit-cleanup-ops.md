---
name: Post-Retrofit Cleanup for OPS
about: Track remaining issues after v5.0 nomenclature retrofit in STK_OPS-ops-operations
title: "[OPS] Post-v5.0 Retrofit Cleanup"
labels: nomenclature-v5.0, cleanup, ops
assignees: ''
---
...
**AoR:** OPS  
**Portal Directory:** `STK_OPS-ops-operations`  
**Report:** `STK_OPS-ops-operations/00_AMPEL360_SPACET_Q10_GEN_PLUS_PR_GEN_LC01_K04_OPS__v5-retrofit-report_RPT_I01-R01_ACTIVE.md`

## Context

This issue tracks remaining cleanup tasks after the Nomenclature v5.0 retrofit for the **OPS** area of responsibility. All files in this portal have been successfully migrated to v5.0 format with 100% validation compliance, but some cross-references and links require manual review.

## Retrofit Summary

- **Files migrated:** 120 files in this AoR
...
**How to Check:**
```bash
cd AMPEL360-SPACE-T-PORTAL/STK_OPS-ops-operations
...
**Assigned Workspace:** `STK_OPS-ops-operations`
