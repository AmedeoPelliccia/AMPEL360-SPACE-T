---
name: Post-Retrofit Cleanup for MRO
about: Track remaining issues after v5.0 nomenclature retrofit in STK_MRO-mro-mro-maintenance
title: "[MRO] Post-v5.0 Retrofit Cleanup"
labels: nomenclature-v5.0, cleanup, mro
assignees: ''
---
...
This issue tracks remaining cleanup tasks after the Nomenclature v5.0 retrofit for the **MRO** area of responsibility. All files in this portal have been successfully migrated to v5.0 format with 100% validation compliance, but some cross-references and links require manual review.

## Retrofit Summary

- **Files migrated:** 33 files in this AoR
...
**How to Check:**
```bash
cd AMPEL360-SPACE-T-PORTAL/STK_MRO-mro-mro-maintenance
...
**Assigned Workspace:** `STK_MRO-mro-mro-maintenance`
