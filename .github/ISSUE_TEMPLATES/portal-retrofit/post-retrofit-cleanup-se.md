---
name: Post-Retrofit Cleanup for SE
about: Track remaining issues after v5.0 nomenclature retrofit in STK_SE-se-systems-engineering
title: "[SE] Post-v5.0 Retrofit Cleanup"
labels: nomenclature-v5.0, cleanup, se
assignees: ''
---
...
**AoR:** SE  
**Portal Directory:** `STK_SE-se-systems-engineering`  
**Report:** `STK_SE-se-systems-engineering/00_AMPEL360_SPACET_Q10_GEN_PLUS_PR_GEN_LC01_K04_SE__v5-retrofit-report_RPT_I01-R01_ACTIVE.md`

## Context

This issue tracks remaining cleanup tasks after the Nomenclature v5.0 retrofit for the **SE** area of responsibility. All files in this portal have been successfully migrated to v5.0 format with 100% validation compliance, but some cross-references and links require manual review.

## Retrofit Summary

- **Files migrated:** 379 files in this AoR
...
**How to Check:**
```bash
cd AMPEL360-SPACE-T-PORTAL/STK_SE-se-systems-engineering
...
**Assigned Workspace:** `STK_SE-se-systems-engineering`
